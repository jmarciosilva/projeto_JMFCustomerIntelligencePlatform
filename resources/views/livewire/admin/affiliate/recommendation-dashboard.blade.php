<div class="space-y-6">
    <div class="flex items-center justify-between">
        <h1 class="text-3xl font-bold text-gray-900">🎯 Recomendação JMF</h1>
            ...
            @foreach ($recommendations as $rec)
                <div class="bg-white rounded-lg shadow p-6 border-l-4 border-blue-500 hover:shadow-lg transition">
                    <div class="flex items-start justify-between mb-4">
                        <div>
                            <h3 class="text-xl font-bold text-gray-900">{{ $rec['product_name'] }}</h3>
                    ...
                    <div class="grid grid-cols-3 gap-4 mb-4">
                        <div class="bg-gray-50 rounded p-3">
                            ...
                            <p class="text-lg font-bold text-gray-900">{{ $rec['trend_score'] }}</p>
                        </div>
                        <div class="bg-gray-50 rounded p-3">
                            <p class="text-xs text-gray-600">Oportunidade</p>
                            <p class="text-lg font-bold text-gray-900">{{ $rec['opportunity_score'] }}</p>
                        </div>
                        <div class="bg-gray-50 rounded p-3">
                            <p class="text-xs text-gray-600">Desempenho</p>
                            <p class="text-lg font-bold text-gray-900">{{ $rec['performance_score'] }}</p>
                        </div>
                    </div>

                    <div class="space-y-2">
                        <p class="text-sm font-semibold text-gray-900">Motivos:</p>
                        <ul class="space-y-1">
