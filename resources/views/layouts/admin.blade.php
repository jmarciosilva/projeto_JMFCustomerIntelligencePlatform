            ...
            <nav class="flex-1 px-3 py-4 space-y-1">
                ...
                @can('affiliate_programs.view')
                    <a href="{{ route('admin.affiliate.programs.index') }}"
                       class="block rounded-lg px-3 py-2 text-sm font-medium {{ request()->routeIs('admin.affiliate.programs.*') ? 'bg-slate-800 text-white' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
                ...
                @can('affiliate_products.view')
                    <a href="{{ route('admin.affiliate.products.index') }}"
                       class="block rounded-lg px-3 py-2 text-sm font-medium {{ request()->routeIs('admin.affiliate.products.*') ? 'bg-slate-800 text-white' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
                ...
                <a href="{{ route('admin.affiliate.analytics.index') }}"
                   class="block rounded-lg px-3 py-2 text-sm font-medium {{ request()->routeIs('admin.affiliate.analytics.*') ? 'bg-slate-800 text-white' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
                    📊 Affiliate Analytics
                </a>

                <a href="{{ route('admin.affiliate.recommendations.index') }}"
                   class="block rounded-lg px-3 py-2 text-sm font-medium {{ request()->routeIs('admin.affiliate.recommendations.*') ? 'bg-slate-800 text-white' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
                    🎯 Recomendações JMF
                </a>
                ...
                @can('watchlists.view')
                    ...
                    <a href="{{ route('admin.trends.google-trends') }}"
                       class="block rounded-lg px-3 py-2 text-sm font-medium ml-4 {{ request()->routeIs('admin.trends.google-trends') ? 'bg-slate-800 text-white' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
                        📊 Google Trends
                    </a>
                @endcan
